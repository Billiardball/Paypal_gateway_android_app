...
public class RequestParamUtils {
    ...
    //Calculate tax
    public static final String CALCULATE_TAX = "calculate_tax";
    ...
    public static final String BILLING_ASSRESS = "billing_address_1";
    ...
    public static final String SHIPPING_ADDRESS = "shipping_address_1";
    public static final String SHIPPING_POSTCODE = "shipping_postcode";
    public static final String STATUS = "status";
    public static final String GENERATEKEYHASH = "generatekeyhash";
