...
public class TopRatedProductAdapter extends RecyclerView.Adapter<TopRatedProductAdapter.RecentlyAddedViewHolder> implements OnResponseListner {
    ...
    public TopRatedProductAdapter(Activity activity, OnItemClickListner onItemClickListner) {
    ...
    public RecentlyAddedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RecentlyAddedViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(RecentlyAddedViewHolder holder, final int position) {
    ...
    public class RecentlyAddedViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecentlyAddedViewHolder(View view) {
            super(view);
