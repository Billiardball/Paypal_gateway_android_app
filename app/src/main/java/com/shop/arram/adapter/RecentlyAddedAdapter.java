...
public class RecentlyAddedAdapter extends RecyclerView.Adapter<RecentlyAddedAdapter.RecentlyAddedViewHolder> implements OnResponseListner {
    ...
    public RecentlyAddedAdapter(Activity activity, OnItemClickListner onItemClickListner) {
