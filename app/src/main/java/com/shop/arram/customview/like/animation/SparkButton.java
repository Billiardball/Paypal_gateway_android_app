package com.shop.arram.customview.like.animation;
...
public class SparkButton extends FrameLayout implements View.OnClickListener {
    ...
    void init() {
        ...
        circleView.setColors(Color.parseColor(((BaseActivity)getContext()).getPreferences().getString(Constant.APP_COLOR,Constant.PRIMARY_COLOR)), Color.parseColor(((BaseActivity)getContext()).getPreferences().getString(Constant.APP_COLOR,Constant.PRIMARY_COLOR)));
        ...
        dotsView.setColors(Color.parseColor(((BaseActivity)getContext()).getPreferences().getString(Constant.APP_COLOR,Constant.PRIMARY_COLOR)), Color.parseColor(((BaseActivity)getContext()).getPreferences().getString(Constant.APP_COLOR,Constant.PRIMARY_COLOR)));
    ...
    public void setActivetint(int activeImageTint) {
    ...
    private void getStuffFromXML(AttributeSet attr) {
        ...
        primaryColor = ContextCompat.getColor(getContext(), a.getResourceId(R.styleable.sparkbutton_sparkbutton_primaryColor, R.color.colorPrimary));
        secondaryColor = ContextCompat.getColor(getContext(), a.getResourceId(R.styleable.sparkbutton_sparkbutton_secondaryColor, R.color.colorPrimaryTransperent));
